...
export default function Login() {
  ...
  const [nowCode, setNowCode] = useState(getDemoCode('RETAIL-DEMO'));
  const navigate = useNavigate();

  useEffect(() => {
  const t = setInterval(() => setNowCode(getDemoCode('RETAIL-DEMO')), 1000);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-6">
      <div className="grid w-full max-w-5xl grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="relative hidden md:block bg-white rounded-2xl border border-gray-200 shadow-sm p-10 overflow-hidden">
          ...
          <h2 className="text-3xl font-bold text-gray-900">Retail Portal</h2>
          <p className="mt-2 text-gray-600">Point of sale, schedule, and retail reports.</p>
          <ul className="mt-6 space-y-2 text-sm text-gray-700">
            <li>• Role: Retail</li>
            <li>• Access: POS, Calendar, Reports</li>
          ...
          <div className="absolute -bottom-6 -right-6 w-48 h-96 rotate-6">
            <div className="relative h-full w-full rounded-3xl bg-black/90 p-3 shadow-2xl ring-8 ring-gray-200">
              <div className="h-full w-full rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 p-4 flex flex-col">
                ...
                <div className="mt-4 text-gray-300 text-xs">RETAIL-DEMO</div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-gray-600">Enter your credentials to access the Retail workspace.</p>
          </div>
          ...
          <div className="mt-6 rounded-lg bg-gray-50 border border-gray-200 p-3 text-sm text-gray-700">
            ...
            <div className="mt-1 text-gray-600">Username: Retail &nbsp;•&nbsp; Password: 1234</div>

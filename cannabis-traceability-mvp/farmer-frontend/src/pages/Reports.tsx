...
export default function Reports() {
  ...
  <Card title="Farmer Reports" subtitle="Templates tailored for farm operations">
      ...
      <Card title="About" subtitle="Generated in-browser for demo purposes">
        <div className="text-sm text-gray-700 space-y-2">
          <p>These report templates are designed for farmers and operators. Downloads are generated client-side as CSV samples with headers and a few mock rows (where provided).</p>
